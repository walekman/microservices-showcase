...
- Flyway vs. `ddl-auto` for schema management — revisit before Plan 3 or later deploys to two service schemas (Account + Transfer). Currently using `ddl-auto: update`.
