 ...
 * "customer" expands to "transfer-executor"/"account-reader"/"account-editor"/"fraud-checker"/"fx-reader")
 ...
 * "ROLE_" prefix, so hasAuthority("fx-reader") matches exactly what Keycloak granted.
 */
